<template>
	...
	<div class="builder" :class="{ rtl: is_rtl }">
		...
		<div class="locale-selector">
			<button type="button" class="lang-en" @click="updateLocale('en')"
				:class="{ 'activeLang': current_lang == 'en' }">
				<img src="static/images/us.svg" alt="English">
			</button>
			<button type="button" class="lang-ru" @click="updateLocale('ru')"
				:class="{ 'activeLang': current_lang == 'ru' }">
				<img src="static/images/ru.svg" alt="Russian">
			</button>
			<button type="button" class="lang-he" @click="updateLocale('he')"
				:class="{ 'activeLang': current_lang == 'he' }">
		...
		<div class="builder-form-wrapper">
				...
				<div class="form-row is-setup_settings-row">
					...
					<div class="setup_inputs_wrapper">
						...
						<label class="inline" v-if="!free_mode">
							...
							<span v-html="sanitizeHtml(locale[current_lang].mobile)"></span>
						</label>

						<label class="inline">
							<input type="checkbox" v-model="json.setup.jquery">
							<span v-html="sanitizeHtml(locale[current_lang].jquery)"></span>
						</label>
			...
			<div class="builder-live" v-if="code">
				...
				<div class="builder-live-content" :style="{
					...
					<div class="builder-lorem" v-html="sanitizeHtml(locale[current_lang].lorem_ipsum)"></div>

					<div id="wp_access_helper_container" class="accessability_container active" :class="{
							...
							<div class="access_container_inner">
								...
								<div class="a_module wah_font_resize">
									<div class="a_module_title">
										{{ advancedSettings ? advanced.font_resize :
											locale[current_live_lang].live.font_resize }}
									</div>
									<div class="a_module_exe font_resizer">
										...
										<button type="button" class="wah-action-button wah-font-reset wahout">
											{{ advancedSettings ? advanced.reset_font_size :
								...
								<div class="a_module wah_keyboard_navigation"
									v-if="!json.setup.hide.keyboard_navigation">
									<div class="a_module_exe">
										<button type="button"
											class="wah-action-button wahout wah-call-keyboard-navigation">
											{{ advancedSettings ? advanced.keyboard_navigation :
								...
								<div class="a_module wah_readable_fonts" v-if="!json.setup.hide.readable_fonts">
									<div class="a_module_exe readable_fonts">
										<button type="button" class="wah-action-button wahout wah-call-readable-fonts">
											{{ advancedSettings ? advanced.readable_font
								...
								<div class="a_module wah_contrast_trigger" v-if="!json.setup.hide.contrast">
									...
									<div class="a_module_exe">
										<button type="button" id="contrast_trigger"
											class="contrast_trigger wah-action-button wahout wah-call-contrast-trigger">
											{{ advancedSettings ? advanced.choose_color :
								...
								<div class="a_module wah_highlight_links" v-if="!json.setup.hide.highlight_links">
									<div class="a_module_exe">
										<button type="button" class="wah-action-button wahout wah-call-highlight-links">
											{{ advancedSettings ? advanced.highlight_links :
								...
								<div class="a_module wah_highlight_titles" v-if="!json.setup.hide.highlight_titles">
									<div class="a_module_exe">
										<button type="button"
											class="wah-action-button wahout wah-call-highlight-titles">
											{{ advancedSettings ? advanced.highlight_titles :
								...
								<div class="a_module wah_clear_cookies">
									<div class="a_module_exe">
										<button type="button" class="wah-action-button wahout wah-call-clear-cookies">
											{{ advancedSettings ? advanced.clear_cookies :
								...
								<div class="a_module wah_greyscale">
									<div class="a_module_exe">
										<button type="button" id="greyscale"
											class="greyscale wah-action-button wahout wah-call-greyscale">
											{{ advancedSettings ? advanced.images_greyscale :
								...
								<div class="a_module wah_invert" v-if="!json.setup.hide.invert_colors">
									<div class="a_module_exe">
										<button type="button" class="wah-action-button wahout wah-call-invert">
											{{ advancedSettings ? advanced.invert_colors :
								...
								<div class="a_module wah_remove_animations" v-if="!json.setup.hide.remove_animations">
									<div class="a_module_exe">
										<button type="button" accesskey="a"
											class="wah-action-button wahout wah-call-remove-animations">
											{{ advancedSettings ? advanced.remove_animations :
		...
		<div class="advanced-settings-container" v-if="free_mode == false">
			<div class="form-row">
				<h3>
		...
		<div class="buider-preview builder-code" v-if="code">
			...
			<div class="builder-step-3">
				...
				<div class="step-description step3-description">
					<p v-html="sanitizeHtml(locale[current_lang].step3_description)"></p>
					<div class="code-editor" contenteditable="true">
						<p v-html="sanitizeHtml(step3_scripts_jquery)" v-if="!json.setup.jquery"></p>
						<p v-html="sanitizeHtml(locale[current_lang].step3_script_config)"></p>
						<p>&lt;script src="https://accessibility-helper.co.il/remote/wahpro?uid={{ uid }}"
...
export default {
	...
	methods: {
		sanitizeHtml(html) {
			...
			var dangerousNodes = container.querySelectorAll('script, iframe, object, embed, link[rel="import"]');
			dangerousNodes.forEach(function (node) {
				node.remove();
			});
